...
<%--
		...
		alert(path);--%>
	if (sure) {
			window.location.href = "${pageContext.request.contextPath}/customer/deleteCustomer.action?custId="
					+ custId;
		}
	}
</SCRIPT>
											...
											<TBODY>
												<TR>
													...
													<TD><s:select name="custSource.dictId"
															...
															listKey="dictId" listValue="dictItemName" class="textbox"
															id="sChannel2" style="WIDTH: 180px"></s:select></TD>
													<TD>客户级别：</TD>
													<TD><s:select name="custLevel.dictId"
															list="custLevels" headerKey="" headerValue="---请选择---"
															listKey="dictId" listValue="dictItemName" class="textbox"
															id="sChannel2" style="WIDTH: 180px"></s:select></TD>
													<TD><s:submit value="筛选"></s:submit> <%--
