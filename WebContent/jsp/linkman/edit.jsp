				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5 border=0>
							<tr>
								<td>所属客户：</td>
								<td colspan="3"><s:select name="customer.custId"
										list="customers" headerKey="" headerValue="---请选择---"
										listKey="custId" listValue="custName" class="textbox"
										id="sChannel2" style="WIDTH: 180px"></s:select></td>
							</tr>
							<TR>
								<td>联系人名称：</td>
								<td><s:textfield class="textbox" id="sChannel2"
										style="WIDTH: 180px" maxLength="50" name="lkmName"
										value="%{lkmName }"></s:textfield></td>
								<td>联系人性别：</td>
								<td><input type="radio" value="男" name="lkmGender"
									${lkmGender=="男"?"checked":""}>男 <input type="radio"
									value="女" name="lkmGender" ${lkmGender=="女"?"checked":""}>女
								</td>
							</TR>
							<TR>
								<td>联系人办公电话 ：</td>
								<td><s:textfield class="textbox" id="sChannel2"
										...
										value="%{lkmPhone }"></s:textfield></td>
								<td>联系人手机 ：</td>
								<td><s:textfield class="textbox" id="sChannel2"
										style="WIDTH: 180px" maxLength="50" name="lkmMobile"
										value="%{lkmMobile }"></s:textfield></td>
							</TR>
							<TR>
								<td>联系人邮箱 ：</td>
								<td><s:textfield class="textbox" id="sChannel2"
										style="WIDTH: 180px" maxLength="50" name="lkmEmail"
										value="%{lkmEmail }"></s:textfield></td>
								<td>联系人职位 ：</td>
								<td><s:textfield class="textbox" id="sChannel2"
										style="WIDTH: 180px" maxLength="50" name="lkmPosition"
										value="%{lkmPosition }"></s:textfield></td>
							</TR>
							<TR>
								<td>联系人简介 ：</td>
								<td colspan="2"><textarea class=textbox id=sChannel2
										style="WIDTH: 180px" name="lkmMemo">${lkmMemo}</textarea></td>
							</TR>
							<tr>
